	...
	<head>
		...
		<script type="text/javascript">
			function deleteCart(pid) {
				if(confirm("是否删除该商品？")){
				    location.href="${pageContext.request.contextPath}/product?method=deleteCart&pid="+pid;
				}
            }
            function clearCart() {
                if(confirm("是否清空购物车？")){
			...
			<div class="container">
						...
						<table class="table table-bordered">
							...
							<c:forEach items="${cart.cartItemMap}" var="entry">
								<tr class="active">
									...
									<td width="15%">
										<span class="subtotal">￥${entry.value.product.shop_price}</span>
									</td>
									<td>
										<a href="javascript:;" onclick="deleteCart('${entry.value.product.pid}')" class="delete">删除</a>
									</td>
								</tr>
							</c:forEach>
				...
				<div style="margin-right:130px;">
					...
					<div style="text-align:right;margin-top:10px;margin-bottom:10px;">
						...
						<a href="${pageContext.request.contextPath }/product?method=sunmitOrder">
