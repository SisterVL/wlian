			...
			function findOrderInfoByOid(oid) {
			    ...
			    $.post(
					...
					function (data) {
					    ...
					    //拼接json
						/*[{"pimage":"products/1/c_0014.jpg","shop_price":2298.0,
						"pname":"vivo X5Pro","subtotal":2298.0,"count":1}]*/
						var content = "<tr id='showTableTitle'><th width='20%'>图片</th><th width='25%'>商品</th><th width='20%'>价格</th><th width='15%'>数量</th>\n" +
