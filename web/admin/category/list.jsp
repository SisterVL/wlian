				...
				<c:forEach items="${categoryList}" var="category">
					<tr onmouseover="this.style.backgroundColor = 'white'"
						...
						<td align="center" style="HEIGHT: 22px">
							<a href="${ pageContext.request.contextPath }/admin?method=uCategory&cid=${category.cid}&cname=${category.cname}">
							<img
						...
						<td align="center" style="HEIGHT: 22px"><a
								href="${ pageContext.request.contextPath }/admin?method=delectCategory&cid=${category.cid}">
